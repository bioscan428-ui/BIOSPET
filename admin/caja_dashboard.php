...
<head>
    ...
    <style>
        ...
        .btn-formatos { background: #9c27b0; color: white; padding: 5px 10px; border-radius: 5px; border: none; cursor: pointer; font-size: 11px; transition: background 0.3s; }
        .btn-formatos:hover { background: #7b1fa2; }
        ...
        .modal-content.modal-grande { max-width: 800px; width: 90%; }
        .modal-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; }
        .modal-header h2, .modal-header h3 { margin: 0; }
        .close-modal, .close-formatos, .close-formatos-cita { cursor: pointer; font-size: 28px; color: white; background: none; border: none; }
        ...
        .formato-item:hover { background: #f0f0f0; }
        .btn-cargar { background: #4caf50; color: white; border: none; padding: 8px 15px; border-radius: 5px; cursor: pointer; }
        .btn-cargar:hover { background: #45a049; }
    </style>
</head>
<body>
